 ...
 * </p>
 */
public class DrawerIndicator extends Drawable
  {
...
// wont look different
   ...
   */
  public DrawerIndicator( Context context, int showDrawableResourceId, int hideDrawableResourceId )
    {
...
// the arrow pointing the other way for RTL.
    ...
    if ( DEBUGGING_ENABLED ) Log.d( LOG_TAG, "  mSpin = " + mSpin + ", mVerticalMirror = " + mVerticalMirror + ", flipToPointRight = " + flipToPointRight + ", canvasRotate = " + canvasRotate );
    ...
    if ( mSpin )
      ...
      {
      canvasRotationForHideDrawable = 180;
      }
