 ...
 *
 * This has been copied from the Android support library, and modified so
...
//    }
   ...
   * @param activity                  The Activity hosting the drawer. Should have an ActionBar.
   * @param drawerLayout              The DrawerLayout to link to the given Activity's ActionBar
   * @param slider                    The slider to be used as the indicator.
   * @param openDrawerContentDescRes  A String resource to describe the "open drawer" action
   *                                  for accessibility
   * @param closeDrawerContentDescRes A String resource to describe the "close drawer" action
   *                                  for accessibility
...
//    }
  ...
  <T extends Drawable & DrawerToggle> CustomActionBarDrawerToggle( Activity activity,
    ...
    if ( slider == null )
      {
      mSlider = new DefaultDrawerIndicator( activity,
...
//      }
  ...
  public void onDrawerSlide( View drawerView, float slideOffset )
    ...
    if ( DEBUGGING_ENABLED )
      {
      Log.d( LOG_TAG, "onDrawerSlide( drawerView = " + drawerView + ", slideOffset = " + slideOffset + " )" );
      Log.d( LOG_TAG, "  mSlider = " + mSlider );
      }
  ...
  public void onDrawerOpened( View drawerView )
    ...
    if ( DEBUGGING_ENABLED )
      {
      Log.d( LOG_TAG, "onDrawerOpened( drawerView = " + drawerView + " )" );
      Log.d( LOG_TAG, "  mSlider = " + mSlider );
      }
  ...
  public void onDrawerClosed( View drawerView )
    ...
    if ( DEBUGGING_ENABLED )
      {
      Log.d( LOG_TAG, "onDrawerClosed( drawerView = " + drawerView + " )" );
      Log.d( LOG_TAG, "  mSlider = " + mSlider );
      }
  ...
  static class DefaultDrawerIndicator extends DrawerArrowDrawable implements DrawerToggle
    {
    private final Activity mActivity;

    public DefaultDrawerIndicator( Activity activity, Context themedContext )
      {
      super( themedContext );
  ...
  static public class CustomDrawerIndicatorToggle extends CustomDrawerIndicator implements DrawerToggle
    ...
    public CustomDrawerIndicatorToggle( Context context, int showDrawableResourceId, int hideDrawableResourceId )
      {
      super( context, showDrawableResourceId, hideDrawableResourceId );
      }
  ...
  private static class JellybeanMr2Delegate implements Delegate
    {
    static private final String LOG_TAG = "JellybeanMr2Delegate";
    ...
    public void setActionBarUpIndicator( Drawable drawable, int contentDescRes )
      ...
      if ( DEBUGGING_ENABLED )
        {
        Log.d( LOG_TAG, "setActionBarUpIndicator( drawable = " + drawable + ", contentDescRes = " + contentDescRes + " )" );
        }
  ...
  static class ToolbarCompatDelegate implements Delegate
    {
    static private final String LOG_TAG = "ToolbarCompatDelegate";
    ...
    public void setActionBarUpIndicator( Drawable upDrawable, @StringRes int contentDescRes )
      ...
      if ( DEBUGGING_ENABLED )
        {
        Log.d( LOG_TAG, "setActionBarUpIndicator( upDrawable = " + upDrawable + ", contentDescRes = " + contentDescRes + " )" );
        }
