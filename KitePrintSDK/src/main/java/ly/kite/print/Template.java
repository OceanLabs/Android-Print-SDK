...
public class Template implements Parcelable, Serializable {
    ...
    private void writeObject(java.io.ObjectOutputStream out) throws IOException {
        ...
        out.writeFloat(sizeCm.x);
        out.writeFloat(sizeCm.y);
        out.writeFloat(sizeInches.x);
        out.writeFloat(sizeInches.y);
        out.writeFloat(sizePx.x);
        out.writeFloat(sizePx.y);
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        sizeCm = new PointF(in.readFloat(), in.readFloat());
        sizeInches = new PointF(in.readFloat(), in.readFloat());
        sizePx = new PointF(in.readFloat(), in.readFloat());
